...
export default function ProductsServicesPage() {
  return (
    <AppShell title="Products & services">
      <Card className="rounded-xl border-border p-8 sm:p-10 text-center shadow-[var(--shadow-sm)]">
        ...
        <h2 className="mt-4 text-lg font-semibold tracking-tight">Catalog coming soon</h2>
        <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground">
          Line items already work on invoices and quotes. A dedicated product library with SKUs, pricing tiers, and
          bundles will land here next.
        </p>
